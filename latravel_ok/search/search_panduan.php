        ...
        <tr>
            ...
            <td>
                <div class='action-btn'>
                    ...
                    <a href='../database/delete.php?id_panduan=<?= $pand['id'] ?>' class='delete-btn' onclick="return confirm('Yakin ingin menghapus panduan ini?');"><img src='../assets/icon/sampah.svg'></a>
                </div>
            </td>
        </tr>
        <?php $i++; endforeach; ?>
