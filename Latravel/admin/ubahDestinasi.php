<?php
    ...
    if (isset($_GET["id_destinasi"])) {
        ...
        $sql_select_destinasi = mysqli_query($conn, "SELECT * FROM destinasi WHERE id = $id_destinasi");
        $destinasi = mysqli_fetch_assoc($sql_select_destinasi);
    }
    ...
    if (isset($_POST["submit"])){
        ...
        if ($foto == ""){
            $sql = "UPDATE destinasi SET judul = '$judul', subjudul = '$subjudul', deskripsi = '$deskripsi' WHERE id = $id_destinasi";
            ...
            if ($result){
                echo "
                    <script>
                        alert('Berhasil Mengubah Destinasi');
        ...
        if (in_array($ekstensi, $support)){
            if (move_uploaded_file($temp, $direktori)){
                ...
                $sql = "UPDATE destinasi SET judul = '$judul', subjudul = '$subjudul', deskripsi = '$deskripsi', foto = '$namabaru' WHERE id = $id_destinasi";
            ...
            <div class="content-container">
                <div class="form-section">
                        <div class="form-group-2">
                            ...
                            <input type="text" name="judul" id="judul" placeholder="Masukkan judul..." value="<?php echo $destinasi['judul']?>">
                        </div>

                        <div class="form-group-2">
                            <label for="subjudul">SubJudul</label>
                            <input type="text" name="subjudul" id="subjudul" placeholder="Masukkan subjudul..." value="<?php echo $destinasi['subjudul']?>">
                        </div>

                        <div class="form-group-2">
                            <label for="deskripsi">Deskripsi</label>
                            <textarea id="deskripsi" name="deskripsi" placeholder="Masukkan deskripsi..."><?php echo $destinasi['deskripsi']?></textarea>
                        </div>
                ...
                <div class="upload-section">
                    <div class="upload-placeholder">
                        <?php $direktori = "../database/foto_destinasi/" . $destinasi["foto"];?>
